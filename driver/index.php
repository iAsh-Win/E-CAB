                              ...
                              while ($ride = mysqli_fetch_assoc($result2)) {
                                ...
                                if ($bookings) {
                                  ...
                                  if ($bookingdata['status'] == 'Confirmed') {
                                    ...
                                    if ($req) {
                                      if ($req['driverID'] == $row['driverid'] && $req['status'] != 'Decline') {
                                      ...
                                      if ($req['driverID'] != $row['driverid'] && $req['status'] == 'Decline') {
                                        ...
                                        echo '<td id="' . $bookingdata['bookid'] . '">
                                        <button type="button" id="ac-btn" class="btn btn-info btn-rounded btn-sm" onclick="Accept_btn(\'' . $bookingdata['bookid'] . '\')">Accept</button>
